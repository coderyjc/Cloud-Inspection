...
import { getDamageAll, getDamageImage} from "@/api/table"
...
export default {
  ...
  methods: {
    async get_damage_list_all(){
      if(this.pn > this.pages) return
      await getDamageAll(this.pn, this.limit).then(res =>{
    ...
    handleClick(row){
      ...
      this.getDamagePicture(this.currentSelect.id);
    },
    ...
    handleCurrentChange(val) {
      this.pn = val
      this.get_damage_list_all(this.pn, this.limit)
    },
